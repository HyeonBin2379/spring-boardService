                        ...
                        <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <c:forEach var="board" items="${responseDTO.dtoList}" >
                                    <tr>
                                        <th scope="row"><c:out value="${board.getBId()}"/></th>
                                        <td><a href="/board/read?bId=${board.getBId()}&${pageRequestDTO.link}"><c:out value="${board.getTitle()}"/></a></td>
                                        <td><c:out value="${board.getWriter()}"/></td>
                                        <td><c:out value="${board.getHits()}"/></td>
                                        <td><c:out value="${board.getCreatedDate()}"/></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
